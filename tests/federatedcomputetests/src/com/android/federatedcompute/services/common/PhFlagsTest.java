...
import static com.android.federatedcompute.services.common.Flags.FCP_TF_ERROR_RESCHEDULE_SECONDS;
...
import static com.android.federatedcompute.services.common.PhFlags.FCP_TF_ERROR_RESCHEDULE_SECONDS_CONFIG_NAME;
...
public class PhFlagsTest {
    ...
    public static void tearDown() {
        ...
        DeviceConfig.setProperty(
                DeviceConfig.NAMESPACE_ON_DEVICE_PERSONALIZATION,
                FCP_TF_ERROR_RESCHEDULE_SECONDS_CONFIG_NAME,
                Long.toString(FCP_TF_ERROR_RESCHEDULE_SECONDS),
                /* makeDefault= */ false);
    }
    ...
    @Test
    public void testGetFcpTfErrorRescheduleSeconds() {
        // Without Overriding
        DeviceConfig.setProperty(
                DeviceConfig.NAMESPACE_ON_DEVICE_PERSONALIZATION,
                FCP_TF_ERROR_RESCHEDULE_SECONDS_CONFIG_NAME,
                Long.toString(FCP_TF_ERROR_RESCHEDULE_SECONDS),
                /* makeDefault= */ false);
        assertThat(FlagsFactory.getFlags().getFcpTfErrorRescheduleSeconds())
                .isEqualTo(FCP_TF_ERROR_RESCHEDULE_SECONDS);

        // Now overriding the value from PH.
        long overrideFcpTfErrorRescheduleSeconds = 4000L;
        DeviceConfig.setProperty(
                DeviceConfig.NAMESPACE_ON_DEVICE_PERSONALIZATION,
                FCP_TF_ERROR_RESCHEDULE_SECONDS_CONFIG_NAME,
                Long.toString(overrideFcpTfErrorRescheduleSeconds),
                /* makeDefault= */ false);

        Flags phFlags = FlagsFactory.getFlags();
        assertThat(phFlags.getFcpTfErrorRescheduleSeconds())
                .isEqualTo(overrideFcpTfErrorRescheduleSeconds);
    }
