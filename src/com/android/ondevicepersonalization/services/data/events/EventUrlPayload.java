...
public class EventUrlPayload implements Serializable {
    ...
    /** If true, start an isolated process to compute event metrics. */
    private boolean mEventMetricsRequired = false;
    ...
    /* package-private */ EventUrlPayload(
            @NonNull Event event,
            boolean eventMetricsRequired) {
        this.mEvent = event;
        AnnotationValidations.validate(
                NonNull.class, null, mEvent);
        this.mEventMetricsRequired = eventMetricsRequired;
     ...
     */
    @DataClass.Generated.Member
    public boolean isEventMetricsRequired() {
        return mEventMetricsRequired;
    }
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return true
                ...
                && mEventMetricsRequired == that.mEventMetricsRequired;
    }
    ...
    public int hashCode() {
        ...
        _hash = 31 * _hash + Boolean.hashCode(mEventMetricsRequired);
        return _hash;
    }
    ...
    public static class Builder {
         ...
         */
        @DataClass.Generated.Member
        public @NonNull Builder setEventMetricsRequired(boolean value) {
            checkNotUsed();
            mBuilderFieldsSet |= 0x2;
            mEventMetricsRequired = value;
            return this;
        }
        ...
        public @NonNull EventUrlPayload build() {
            ...
            if ((mBuilderFieldsSet & 0x2) == 0) {
                mEventMetricsRequired = false;
            }
            EventUrlPayload o = new EventUrlPayload(
                    mEvent,
                    mEventMetricsRequired);
            return o;
        }
