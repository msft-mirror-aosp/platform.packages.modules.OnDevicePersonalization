...
public final class TrainingInterval implements Parcelable {
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/packages/modules/OnDevicePersonalization/framework/java/android/ondevicepersonalization/federatedcompute/TrainingInterval.java
    //
    ...
    public static final @android.annotation.NonNull Parcelable.Creator<TrainingInterval> CREATOR
        ...
        @Override
        public TrainingInterval createFromParcel(@android.annotation.NonNull android.os.Parcel in) {
    ...
    @DataClass.Generated(
            ...
            sourceFile = "packages/modules/OnDevicePersonalization/framework/java/android/ondevicepersonalization/federatedcompute/TrainingInterval.java",
            inputSignatures = "public static final  int SCHEDULING_MODE_RECURRENT\npublic static final  int SCHEDULING_MODE_ONE_TIME\nprivate @android.ondevicepersonalization.federatedcompute.TrainingInterval.SchedulingMode int mSchedulingMode\nprivate  long mMinimumIntervalMillis\nclass TrainingInterval extends java.lang.Object implements [android.os.Parcelable]\n@com.android.ondevicepersonalization.internal.util.DataClass(genBuilder=true, genEqualsHashCode=true)")
    @Deprecated
