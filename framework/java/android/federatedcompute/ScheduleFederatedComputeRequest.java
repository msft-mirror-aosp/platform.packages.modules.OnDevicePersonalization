...
public class ScheduleFederatedComputeRequest {
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/packages/modules/OnDevicePersonalization/framework/java/android/ondevicepersonalization/federatedcompute/ScheduleFederatedComputeRequest.java
    //
    ...
    /* package-private */ ScheduleFederatedComputeRequest(
        ...
        AnnotationValidations.validate(
                NonNull.class, null, mTrainingOptions);
    ...
    public boolean equals(@android.annotation.Nullable Object o) {
        ...
        return true
                && java.util.Objects.equals(mTrainingOptions, that.mTrainingOptions);
    }
    ...
    public static class Builder {
        ...
        public @NonNull ScheduleFederatedComputeRequest build() {
            ...
            ScheduleFederatedComputeRequest o = new ScheduleFederatedComputeRequest(
                    mTrainingOptions);
            return o;
        }
    ...
    @DataClass.Generated(
            ...
            sourceFile = "packages/modules/OnDevicePersonalization/framework/java/android/ondevicepersonalization/federatedcompute/ScheduleFederatedComputeRequest.java",
            inputSignatures = "private final @android.annotation.NonNull android.ondevicepersonalization.federatedcompute.TrainingOptions mTrainingOptions\nclass ScheduleFederatedComputeRequest extends java.lang.Object implements []\n@com.android.ondevicepersonalization.internal.util.DataClass(genBuilder=true, genEqualsHashCode=true)")
    @Deprecated
