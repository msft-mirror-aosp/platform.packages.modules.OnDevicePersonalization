...
public final class TrainingOptions implements Parcelable {
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/packages/modules/OnDevicePersonalization/framework/java/android/ondevicepersonalization/federatedcompute/TrainingOptions.java
    //
    ...
    /* package-private */ TrainingOptions(@NonNull android.os.Parcel in) {
        ...
        TrainingInterval trainingInterval = (flg & 0x4) == 0 ? null : (TrainingInterval) in.readTypedObject(TrainingInterval.CREATOR);
    ...
    public static final class Builder {
        ...
        public @NonNull TrainingOptions build() {
            ...
            TrainingOptions o = new TrainingOptions(
                    mJobSchedulerJobId,
                    mPopulationName,
                    mTrainingInterval);
            return o;
    ...
    @DataClass.Generated(
            ...
            sourceFile = "packages/modules/OnDevicePersonalization/framework/java/android/ondevicepersonalization/federatedcompute/TrainingOptions.java",
            inputSignatures = "private  int mJobSchedulerJobId\nprivate @android.annotation.NonNull java.lang.String mPopulationName\nprivate @android.annotation.Nullable android.ondevicepersonalization.federatedcompute.TrainingInterval mTrainingInterval\nclass TrainingOptions extends java.lang.Object implements [android.os.Parcelable]\n@com.android.ondevicepersonalization.internal.util.DataClass(genBuilder=true, genEqualsHashCode=true)")
    @Deprecated
