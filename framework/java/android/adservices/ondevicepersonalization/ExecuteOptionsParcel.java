...
public class ExecuteOptionsParcel implements Parcelable {
    ...
    /** @hide */
    public ExecuteOptionsParcel(@NonNull ExecuteInIsolatedServiceRequest.Options options) {
    ...
    private ExecuteOptionsParcel() {
        this(ExecuteInIsolatedServiceRequest.Options.OUTPUT_TYPE_NULL, -1);
    }
    ...
    public ExecuteOptionsParcel(
            @ExecuteInIsolatedServiceRequest.Options.OutputType int outputType, int maxIntValue) {
