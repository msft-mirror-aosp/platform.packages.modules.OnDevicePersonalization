...
public class TrainingExampleInput implements Parcelable {
    ...
    public static class Builder {
         ...
         *
         * @param populationName Name of the federated compute task.
         * @param taskName One population may have multiple tasks. Task name can be used to uniquely
         *     identify the job.
         * @param collectionName The name of data collection to read from, specified by the
         *     federated task plan configured at federated computation server.
         * @param inputData Input data to create example from. Represents a single joined log
         *     record.
         */
        public Builder(
                @NonNull String populationName,
        ...
        public @NonNull TrainingExampleInput build() {
            ...
            TrainingExampleInput o =
                    new TrainingExampleInput(
                            mPopulationName, mTaskName, mCollectionName, mInputData);
            return o;
        }
