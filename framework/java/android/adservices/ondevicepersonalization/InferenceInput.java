...
public final class InferenceInput {
    ...
    public static class Params {
        ...
        /** The delegate to run model inference. */
        private @Delegate int mDelegateType = 1;
        ...
        private @IntRange(from = 1) int mCpuNumThread = -1;

        /**
         * Creates parameters for running inference on CPU.
         *
         ...
         *     model.
         * @param cpuNumThread the number of threads used for intraop parallelism on CPU, must be
         *     positive number.
         * @param modelType the type of pre-trained model, only support tensorflow lite model now.
         */
        @NonNull
        public static Params createCpuParams(
                @NonNull KeyValueStore keyValueStore,
                @NonNull String modelKey,
                @IntRange(from = 1) int cpuNumThread,
                @ModelType int modelType) {
            return new Params(keyValueStore, modelKey, DELEGATE_CPU, modelType, cpuNumThread);
        }
