...
public class JoinedLogRecord {
    ...
    // To regenerate run:
    // $ codegen
    // $ANDROID_BUILD_TOP/packages/modules/OnDevicePersonalization/framework/java/android/adservices/ondevicepersonalization/JoinedLogRecord.java
    //
    ...
    /* package-private */ JoinedLogRecord(
        ...
        this.mType = type;
        AnnotationValidations.validate(IntRange.class, null, mType, "from", 0, "to", 127);
    ...
    public static class Builder {
        ...
        /**
         * The service-assigned type that identifies the event data. Must be >0 and <128. If type is
         * 0, it is an Request-only row with no associated event.
         */
        @DataClass.Generated.Member
        public @android.annotation.NonNull Builder setType(
                @IntRange(from = 0, to = 127) int value) {
            checkNotUsed();
        ...
        /** Request data logged in a {@link RequestLogRecord} */
        @DataClass.Generated.Member
        public @android.annotation.NonNull Builder setRequestData(
                @android.annotation.NonNull ContentValues value) {
            checkNotUsed();
        ...
        /** Event data logged in an {@link EventLogRecord} */
        @DataClass.Generated.Member
        public @android.annotation.NonNull Builder setEventData(
                @android.annotation.NonNull ContentValues value) {
            checkNotUsed();
        ...
        public @android.annotation.NonNull JoinedLogRecord build() {
            ...
            JoinedLogRecord o =
                    new JoinedLogRecord(
                            mRequestTimeMillis, mEventTimeMillis, mType, mRequestData, mEventData);
            return o;
        }
    ...
    @DataClass.Generated(
            ...
            sourceFile =
                    "packages/modules/OnDevicePersonalization/framework/java/android/adservices/ondevicepersonalization/JoinedLogRecord.java",
            inputSignatures =
                    "private final  long mRequestTimeMillis\nprivate final  long mEventTimeMillis\nprivate final @android.annotation.IntRange int mType\nprivate final @android.annotation.Nullable android.content.ContentValues mRequestData\nprivate final @android.annotation.Nullable android.content.ContentValues mEventData\nclass JoinedLogRecord extends java.lang.Object implements []\n@com.android.ondevicepersonalization.internal.util.DataClass(genBuilder=true, genEqualsHashCode=true)")
    @Deprecated
