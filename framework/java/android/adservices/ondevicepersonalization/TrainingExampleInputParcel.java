...
/**
 * Parcelable version of {@link TrainingExampleInput}
 *
 * @hide
 */
@DataClass(genAidl = false, genHiddenBuilder = true)
public final class TrainingExampleInputParcel implements Parcelable {
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/packages/modules/OnDevicePersonalization/framework/java/android/adservices/ondevicepersonalization/TrainingExampleInputParcel.java
    //
    ...
    /* package-private */ TrainingExampleInputParcel(
    ...
    @DataClass.Generated.Member
    /* package-private */ TrainingExampleInputParcel(@NonNull android.os.Parcel in) {
    ...
    @DataClass.Generated.Member
    public static final @NonNull Parcelable.Creator<TrainingExampleInputParcel> CREATOR
            = new Parcelable.Creator<TrainingExampleInputParcel>() {
        @Override
        public TrainingExampleInputParcel[] newArray(int size) {
            return new TrainingExampleInputParcel[size];
        }

        @Override
        public TrainingExampleInputParcel createFromParcel(@NonNull android.os.Parcel in) {
            return new TrainingExampleInputParcel(in);
        }
    };

    /**
     * A builder for {@link TrainingExampleInputParcel}
     * @hide
     */
    ...
    public static final class Builder {
        ...
        public @NonNull TrainingExampleInputParcel build() {
            checkNotUsed();
            ...
            TrainingExampleInputParcel o = new TrainingExampleInputParcel(
                    mPopulationName,
                    mTaskName,
                    mResumptionToken);
            return o;
