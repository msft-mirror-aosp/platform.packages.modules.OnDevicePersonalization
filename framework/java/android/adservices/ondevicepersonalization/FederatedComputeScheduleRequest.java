...
public final class FederatedComputeScheduleRequest {
    ...
    /* package-private */ FederatedComputeScheduleRequest(
    ...
    /** A builder for {@link FederatedComputeScheduleRequest} */
    @SuppressWarnings("WeakerAccess")
    @DataClass.Generated.Member
    public static final class Builder {

        private @NonNull FederatedComputeScheduler.Params mParams;
         ...
         * should match task plan configured at remote federated compute server.
         */
        @DataClass.Generated.Member
        ...
        public @NonNull FederatedComputeScheduleRequest build() {
            checkNotUsed();
            ...
            FederatedComputeScheduleRequest o =
                    new FederatedComputeScheduleRequest(mParams, mPopulationName);
            return o;
        }
