...
public class TrainingInterval {
     ...
     */
    private static final int SCHEDULING_MODE_UNKNOWN = 0;

    private static final int SCHEDULING_MODE_RECURRENT = 1;

    private static final int SCHEDULING_MODE_ONE_TIME = 2;
    @SchedulingMode private int mSchedulingMode = SCHEDULING_MODE_UNKNOWN;
    ...
    @android.annotation.IntDef(
            ...
            value = {SCHEDULING_MODE_UNKNOWN, SCHEDULING_MODE_RECURRENT, SCHEDULING_MODE_ONE_TIME})
    ...
    /* package-private */ static String schedulingModeToString(@SchedulingMode int value) {
        switch (value) {
            case SCHEDULING_MODE_UNKNOWN:
                return "SCHEDULING_MODE_UNKNOWN";
    ...
    /* package-private */ TrainingInterval(
        ...
        if (!(mSchedulingMode == SCHEDULING_MODE_UNKNOWN)
    ...
    public static class Builder {
        ...
        public @NonNull TrainingInterval build() {
            ...
            if ((mBuilderFieldsSet & 0x1) == 0) {
                mSchedulingMode = SCHEDULING_MODE_UNKNOWN;
            }
